...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etBaseAmount = findViewById(R.id.baseAmountEditText)
        seekBarTip = findViewById(R.id.tipPercemtSeekBar)
        tvTipPercent = findViewById(R.id.tipPercentLabelTextView)
        tvTipAmount = findViewById(R.id.tipAmountTextView)
        tvTotalAmount = findViewById(R.id.totalAmountTextView)
